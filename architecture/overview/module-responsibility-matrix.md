...
| 05 | **Analysis Engine** | Orchestrate analysis sub-engines into an insight package | Classified decision | Coordinate Impact, Similarity, Forecast, and Recommendation sub-engines | Insight package + `insight.ready` event | Review & Approval Portal |
...
| **Similarity Engine** | Find related historical decisions | Classified decision | Embedding search, vector similarity | Similar decisions list | Analysis Engine |
